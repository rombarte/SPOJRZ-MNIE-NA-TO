<?php
	...
	if (!$baza_polaczenie) {
		...
		(mysqli_query($baza_polaczenie, "INSERT INTO komputer (`komputer_id`, `komputer_adres`, `komputer_opis`, `komputer_status`, `komputer_data`) VALUES (md5(1),'192.168.0.1','Dziwny adres, nieprawdaż?',1,NOW());") == false) ||
		(mysqli_query($baza_polaczenie, "INSERT INTO komputer (`komputer_id`, `komputer_adres`, `komputer_opis`, `komputer_status`, `komputer_data`) VALUES (md5(2),'192.168.1.1','Stary adres routera',7,NOW());") == false) ||
